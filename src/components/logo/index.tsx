...
const Logo = (props: logoType)=>{
    ...
    return(
        <figure style={{width: "10rem", margin: "0", display: "flex", alignItems: "center"}} >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 208.3 27.7" fill={props.fillSvg ? props.fillSvg : undefined} >
